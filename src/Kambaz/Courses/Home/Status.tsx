...
import { FaCheckCircle, FaHome, FaRegChartBar, FaRegBell, FaStream } from "react-icons/fa";
 ...
 return (
   <div id="wd-course-status" style={{ width: "350px" }}>
     ...
     <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       ...
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <FaRegBell className="me-2 fs-5" /> New Announcement </Button>
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
       <FaRegChartBar className="me-2 fs-5" /> New Analytics </Button>
       <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
